...
public class SecurityConfig 
{
    ...
    .requestMatchers(HttpMethod.POST, "/user","/posts").permitAll().anyRequest().authenticated())    // enable authentication for every request  auth -> auth.requestMatchers("/user").permitAll()
